...
class SiteConfig(db.Model):
    ...
    # 默认网站配置
    DEFAULT_CONFIGS = [
        {'key': 'site_name', 'value': 'LI-CMS', 'description': '网站名称'},
        {'key': 'site_keywords', 'value': 'LI-CMS,技术,博客', 'description': '网站关键词'},
        ...
        {'key': 'footer_text', 'value': '© 2025 LI-CMS 版权所有', 'description': '页脚文本'},
